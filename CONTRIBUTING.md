...
- **Bug**: describe what you did, what you expected, what happened. Include the runner OS, Go version, and the relevant `runright` output or GitHub Actions log.
...
2. Run `go test -race ./...` and `go vet ./...` before opening.
3. If you changed the binary or action inputs, update `README.md` usage examples.
